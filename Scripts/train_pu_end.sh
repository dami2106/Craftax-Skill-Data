...
#SBATCH --output=/home-mscluster/dharvey/HiSD/rl_experiments/end_pu_models_groundtruth.out  # Standard output and error log
...
--features_name 'pca_features_650' --old_data_mode --save_dir 'pu_end_models_groundtruth'