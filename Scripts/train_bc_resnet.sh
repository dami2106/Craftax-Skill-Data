...
#SBATCH --output=/home-mscluster/dharvey/HiSD/Experiments/bc_resnet_sp_static_wp.out  # Standard output and error log
...
echo "Done Wood"
python Skill_Learning/bc_resnet.py --skill wooden_pickaxe
