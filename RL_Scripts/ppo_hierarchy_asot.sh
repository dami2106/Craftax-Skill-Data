...
#SBATCH --output=/home-mscluster/dharvey/HiSD/experiments_diss/ppo_hierarchy_asot_woodpick_all_no_pu_smdp_seeds.out  # Standard output and error log
...
# seeds=(888)
seeds=(0 333 9 42 2106 1 404 1408 506)
...
for seed in "${seeds[@]}"; do
    ...
    python ppo_hierarchy.py --skill_list 0 1 2 3 4 --root Traces/stone_pick_static --bc_checkpoint_dir bc_checkpoints_asot\
    --run_name ppo_hierarchy_asot_${seed} --hierarchy_dir Traces/stone_pick_static/hierarchy_data/asot_predicted_hierarchy --symbol_map "" --ppo_seed "$seed"
